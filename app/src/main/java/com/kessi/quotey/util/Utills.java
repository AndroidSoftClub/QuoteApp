...
public class Utills {
    public static String mFolderName = "quotes";

    public static ArrayList<String> getAllImageQuotes(Context context) {
        ...
        for (int i = 0; i < category.length; i++) {
            String[] files = getCatQuotes(context, category[i]);
...
//                    Log.e("folders", folders);
    ...
    public static String[] getCatQuotes(Context context, String folderName) {
...
//                    Log.e("files", file);
    ...
    public static List<String> getTrendQuotes(List<String> list) {
