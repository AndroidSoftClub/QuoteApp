...
public class BGColorAdapter extends RecyclerView.Adapter<BGColorAdapter.ViewHolder> {
    Context context;
    String[] colors;

    public BGColorAdapter(Context context, String[] colors) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        ...
        holder.colorImg.setOnClickListener(v -> {
            ((TextQuotesMakerActivity) context).setBGColor(color);
