...
public class TFavouriteAdapter extends RecyclerView.Adapter<TFavouriteAdapter.ImageHolder> {
    ...
    public TFavouriteAdapter(List<QuotesModel> quotesList, Context context) {
    ...
    public void onBindViewHolder(@NonNull ImageHolder holder, int position) {
        ...
        holder.favIV.setOnClickListener(v -> {
            if (Utills.hasPermissions(context, Utills.permissions)) {
                ...
                if (quotesList.get(position).getFavourite().equals("yes")) {
